...
namespace SilkyNvg.Paths
{
    internal class SubPath
    {
        ...
        private uint AddAnchorGeometry(Vector2 first, Vector2 last, DataAccessibleArrayList<Vertex> verts)
        {
            // Make sure triangle is a triangle
            if (Start.FpEquals(first)) return 0;
            verts.AddRange(
                new Vertex(Start, Vector3.One),
        ...
        private uint AddLineVerts(Vector2 p0, Vector2 p1, DataAccessibleArrayList<Vertex> verts)
        {
            return AddAnchorGeometry(p0, p1, verts);
        }

        private uint AddQuadraticVerts(Vector2 p0, Vector2 p1, Vector2 p2, DataAccessibleArrayList<Vertex> verts)
        {
            verts.AddRange(
        ...
        private uint SplitCubicAndAddVerts(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, float splitTime,  DataAccessibleArrayList<Vertex> verts)
        {
        ...
        internal uint AddCubicVerts(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3,  DataAccessibleArrayList<Vertex> verts)
        {
        ...
        internal uint BuildGeometry(DataAccessibleArrayList<Vertex> verts)
        {
            int pointIndex = 0;
            uint vertexCount = 0;
